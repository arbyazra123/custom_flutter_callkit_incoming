...
data class Data(val args: Map<String, Any?>) {
    ...
    @JsonProperty("emptyAvatar")
    var emptyAvatar: String = (args["emptyAvatar"] as? String) ?: ""
    ...
    fun toBundle(): Bundle {
        ...
        bundle.putString(CallkitConstants.EXTRA_CALLKIT_EMPTY_AVATAR, emptyAvatar)
    ...
    companion object {
        ...
        fun fromBundle(bundle: Bundle): Data {
            ...
            data.emptyAvatar =
                bundle.getString(CallkitConstants.EXTRA_CALLKIT_EMPTY_AVATAR, "")
